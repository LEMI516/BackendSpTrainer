...
public class WebUtil {
    ...
    public static ResponseEntity<String> callGet(WebClient.Builder client, String url, Token tkn) throws Exception {
        Mono<ResponseEntity<String>> mono = client.build().get()
                .uri(url)
                .header("Content-Type", "application/json")
                .header("Authorization", "Bearer " + tkn.getJwttoken())
                .exchange()
    ...
    public static ResponseEntity<String> callPost(WebClient.Builder client, String url, Token tkn, Object obj) throws Exception {
    ...
    public static ResponseEntity<String> callPut(WebClient.Builder client, String url, Token tkn, Object obj) throws Exception {
    ...
    public static ResponseEntity<String> callPutWithOutBody(WebClient.Builder client, String url, Token tkn) throws Exception {
        Mono<ResponseEntity<String>> mono = client.build().put()
                .uri(url)
                .accept(MediaType.APPLICATION_JSON)
                .header("Content-Type", "application/json")
    ...
    public static ResponseEntity<String> callDelete(WebClient.Builder client, String url, Token tkn) throws Exception {
    ...
    public static List<Object> callGetList(WebClient.Builder client, String url, Token tkn, Class type) throws Exception {
    ...
    public static Object callGet(WebClient.Builder client, String url, Token tkn, Class type) {
        Mono<Object> mono = client.build().get()
                .uri(url)
                .accept(MediaType.APPLICATION_JSON)
                .header("Content-Type", "application/json")
                .header("Authorization", "Bearer " + tkn.getJwttoken())
                .exchange()
                .flatMap(resp -> resp.bodyToMono(type));
        return mono.block();
    }
